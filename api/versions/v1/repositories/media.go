...
import (
	...
	"github.com/aofdev/fiber-versioning-boilerplate/api/versions/v1/factories"
...
func (m *mediaRepository) GetMediaByID(id string) (*interface{}, error) {
	doc, err := m.database.FindOne(bson.M{"_id": id, "data_version": "v1.0"})
	if err != nil {
		return nil, err
	}
...
func (m *mediaRepository) GetMediaByIDS(ids []string) (*[]interface{}, error) {
	...
	docs, err := m.database.FindMany(bson.M{"_id": bson.M{"$in": ids}, "data_version": "v1.0"})
	if err != nil {
		return nil, err
	}
