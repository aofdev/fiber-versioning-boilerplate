...
type metaPost struct {
	...
	DislikeCount int    `json:"dislike_count" bson:"dislike_count" example:"30"`  // Number of Dislikes of this media.
...
type templateMedia struct {
	...
	Picture     string    `json:"picture" bson:"picture" example:"https://example.com/222.jpg"`    // The Picture URL in the format Media by the user.
	...
	Hashtag     []string  `json:"hashtag" bson:"hashtag" example:"#hello,#world#go"`               // The content of the Media.
	DataVersion string    `json:"data_version" bson:"data_version" example:"v2.0"`                 // The data version identifier string of the post in the database.
